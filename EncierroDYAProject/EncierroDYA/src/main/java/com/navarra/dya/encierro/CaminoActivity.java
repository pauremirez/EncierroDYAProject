 ...
 * @version 2.0 (beta)
 */
public class CaminoActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.status_en_camino);
        ...
        ImageButton btnCamino = (ImageButton) findViewById(R.id.btnCamino);
        Button btnDatosPaciente = (Button) findViewById(R.id.btnDatosPaciente);

        ImageView camino = (ImageView) findViewById(R.id.encamino);

        if (test.equalsIgnoreCase("true")){
            camino.setImageResource(R.drawable.camino_practicas);
        }else{
            camino.setImageResource(R.drawable.camino);
        }
        ...
        btnCamino.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                params.add(new BasicNameValuePair("status", "hospital"));
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        String status="hospital";
                        editor.putString(TAG_STATUS, status);// Storing string status
                        editor.commit(); // commit changes

                        Intent i = new Intent(CaminoActivity.this, HospitalActivity.class);
        ...
        btnDatosPaciente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(CaminoActivity.this, AllInjuredActivity.class);
                i.putExtra("userId",userId);
                i.putExtra("status","camino");
                i.putExtra("resource",resource);
                i.putExtra("stand",stand);
                i.putExtra("gps_position",gpsPosition);
                i.putExtra(TAG_ID_INJURED, id_injured);
