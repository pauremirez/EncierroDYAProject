...
//   String providerAux="";
 ...
 //   private static final long MIN_TIME_BW_UPDATES = 1000 * 60 * 1; // 1 minute
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.status_hospital);
        ...
        ImageButton btnHospital= (ImageButton) findViewById(R.id.btnHopital);
        ...
        if (test.equalsIgnoreCase("true")){
            hospital.setImageResource(R.drawable.hospital2_practicas);
        }else{
            hospital.setImageResource(R.drawable.hospital2);
        }
/*
...
*/
        ...
        btnHospital.setOnClickListener(new View.OnClickListener() {
            ...
            //    params.add(new BasicNameValuePair("gpsPosition", gpsPosition));
                params.add(new BasicNameValuePair("status", "libre"));
                params.add(new BasicNameValuePair("id_injured", id_injured));
                params.add(new BasicNameValuePair("complete","true"));
        ...
        btnDatosPaciente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString(TAG_STATUS, status);// Storing string status
                editor.commit(); // commit changes
                Intent i = new Intent(HospitalActivity.this, AllInjuredActivity.class);
                i.putExtra("userId",userId);
